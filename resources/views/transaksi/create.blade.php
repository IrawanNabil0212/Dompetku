                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-4">
                            <label for="pemasukan" class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 w-full">
                                <input type="radio" 
                                       id="pemasukan"
                                       name="jenis" 
                                       value="pemasukan"
                            ...
                            <label for="pengeluaran" class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 w-full">
                                <input type="radio" 
                                       id="pengeluaran"
                                       name="jenis" 
                                       value="pengeluaran"
